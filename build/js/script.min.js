      ...
      return function (e) {
        if (e && e.nodeName && "TEXTAREA" === e.nodeName && !n.has(e)) {
          var t,
            ...
            d = function (t) {
              window.removeEventListener("resize", a, !1), e.removeEventListener("input", f, !1), e.removeEventListener("keyup", f, !1), e.removeEventListener("autosize:destroy", d, !1), e.removeEventListener("autosize:update", f, !1), Object.keys(t).forEach(function (n) {
                e.style[n] = t[n];
              }), n.delete(e);
            }.bind(e, {
          ...
          e.addEventListener("autosize:destroy", d, !1), "onpropertychange" in e && "oninput" in e && e.addEventListener("keyup", f, !1), window.addEventListener("resize", a, !1), e.addEventListener("input", f, !1), e.addEventListener("autosize:update", f, !1), e.style.overflowX = "hidden", e.style.wordWrap = "break-word", n.set(e, {
            destroy: d,
            update: f
          }), "vertical" === (t = window.getComputedStyle(e, null)).resize ? e.style.resize = "none" : "both" === t.resize && (e.style.resize = "horizontal"), r = "content-box" === t.boxSizing ? -(parseFloat(t.paddingTop) + parseFloat(t.paddingBottom)) : parseFloat(t.borderTopWidth) + parseFloat(t.borderBottomWidth), isNaN(r) && (r = 0), f();
        }
        function s(t) {
          var n = e.style.width;
  ...
  return function () {
    ...
    class _ {
      ...
      _getHtml() {
        ...
        if (this.customData?.html) return this.customData.html;
        switch (this.type) {
          case i.days:
    ...
    class K {
      ...
      _triggerOnSelect() {
        ...
        i.length && (e = i.map(v), t = o ? n ? s.dateFormat(e) : e.map(e => s.dateFormat(e)) : e.map(e => this.formatDate(e, s.dateFormat))), a({
          date: h ? e : e[0],
    ...
    var U;
    return P(K, "defaults", s), P(K, "version", "3.3.4"), P(K, "defaultGlobalContainerId", "air-datepicker-global-container"), U = K.prototype, Object.assign(U, I), t.default;
  }();
});
/**
 * Swiper 8.4.6
